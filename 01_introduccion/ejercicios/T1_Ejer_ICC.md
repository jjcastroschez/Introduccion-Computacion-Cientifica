...
Te animo a que realices los siguientes ejercicios para acabar de asimilar los contenidos del tema.

---

## ⚙️ Sistema Operativo (SO) y la Terminal

Crea la siguiente estructura de directorios... Hazlo a través de la línea de comandos...

Para realizar el ejercicio consulta la 📋**Chuleta de Comandos Básicos (CLI)**. 
